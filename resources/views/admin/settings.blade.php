...
<div class="settings-container">
        ...
        <div class="settings-content">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <select name="lead_auto_assignment" class="form-input">
                                        <option value="disabled" {{ old('lead_auto_assignment', \App\Models\Setting::get('general.lead_auto_assignment', 'round_robin')) == 'disabled' ? 'selected' : '' }}>Disabled - Manual Assignment</option>
                                        <option value="round_robin" {{ old('lead_auto_assignment', \App\Models\Setting::get('general.lead_auto_assignment', 'round_robin')) == 'round_robin' ? 'selected' : '' }}>Round Robin - Equal Distribution</option>
                                        <option value="skill_based" {{ old('lead_auto_assignment', \App\Models\Setting::get('general.lead_auto_assignment', 'round_robin')) == 'skill_based' ? 'selected' : '' }}>Skill Based - By Vertical Experience</option>
                                        <option value="performance_based" {{ old('lead_auto_assignment', \App\Models\Setting::get('general.lead_auto_assignment', 'round_robin')) == 'performance_based' ? 'selected' : '' }}>Performance Based - Top Performers First</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="duplicate_detection" class="form-input">
                                        <option value="disabled" {{ old('duplicate_detection', \App\Models\Setting::get('general.duplicate_detection', 'phone_email')) == 'disabled' ? 'selected' : '' }}>Disabled</option>
                                        <option value="phone_only" {{ old('duplicate_detection', \App\Models\Setting::get('general.duplicate_detection', 'phone_email')) == 'phone_only' ? 'selected' : '' }}>Phone Number Only</option>
                                        <option value="email_only" {{ old('duplicate_detection', \App\Models\Setting::get('general.duplicate_detection', 'phone_email')) == 'email_only' ? 'selected' : '' }}>Email Only</option>
                                        <option value="phone_email" {{ old('duplicate_detection', \App\Models\Setting::get('general.duplicate_detection', 'phone_email')) == 'phone_email' ? 'selected' : '' }}>Phone + Email (Recommended)</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="max_leads_per_agent" min="0" max="500" class="form-input" 
                                           value="{{ old('max_leads_per_agent', \App\Models\Setting::get('general.max_leads_per_agent', 50)) }}" 
                                           placeholder="50">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="followup_reminder" class="form-input">
                                        <option value="disabled" {{ old('followup_reminder', \App\Models\Setting::get('general.followup_reminder', '1_hour')) == 'disabled' ? 'selected' : '' }}>Disabled</option>
                                        <option value="30_minutes" {{ old('followup_reminder', \App\Models\Setting::get('general.followup_reminder', '1_hour')) == '30_minutes' ? 'selected' : '' }}>30 Minutes</option>
                                        <option value="1_hour" {{ old('followup_reminder', \App\Models\Setting::get('general.followup_reminder', '1_hour')) == '1_hour' ? 'selected' : '' }}>1 Hour</option>
                                        <option value="4_hours" {{ old('followup_reminder', \App\Models\Setting::get('general.followup_reminder', '1_hour')) == '4_hours' ? 'selected' : '' }}>4 Hours</option>
                                        <option value="24_hours" {{ old('followup_reminder', \App\Models\Setting::get('general.followup_reminder', '1_hour')) == '24_hours' ? 'selected' : '' }}>24 Hours</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <select name="default_country_code" class="form-input">
                                        <option value="+91" {{ old('default_country_code', \App\Models\Setting::get('general.default_country_code', '+91')) == '+91' ? 'selected' : '' }}>+91 (India)</option>
                                        <option value="+1" {{ old('default_country_code', \App\Models\Setting::get('general.default_country_code', '+91')) == '+1' ? 'selected' : '' }}>+1 (USA/Canada)</option>
                                        <option value="+44" {{ old('default_country_code', \App\Models\Setting::get('general.default_country_code', '+91')) == '+44' ? 'selected' : '' }}>+44 (UK)</option>
                                        <option value="+61" {{ old('default_country_code', \App\Models\Setting::get('general.default_country_code', '+91')) == '+61' ? 'selected' : '' }}>+61 (Australia)</option>
                                        <option value="+971" {{ old('default_country_code', \App\Models\Setting::get('general.default_country_code', '+91')) == '+971' ? 'selected' : '' }}>+971 (UAE)</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <input type="time" name="business_hours_start" class="form-input" 
                                               value="{{ old('business_hours_start', \App\Models\Setting::get('general.business_hours_start', '09:00')) }}">
                                        <input type="time" name="business_hours_end" class="form-input" 
                                               value="{{ old('business_hours_end', \App\Models\Setting::get('general.business_hours_end', '18:00')) }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="lead_aging_alert" class="form-input">
                                        <option value="0" {{ old('lead_aging_alert', \App\Models\Setting::get('general.lead_aging_alert', '3')) == '0' ? 'selected' : '' }}>Disabled</option>
                                        <option value="1" {{ old('lead_aging_alert', \App\Models\Setting::get('general.lead_aging_alert', '3')) == '1' ? 'selected' : '' }}>1 Day</option>
                                        <option value="3" {{ old('lead_aging_alert', \App\Models\Setting::get('general.lead_aging_alert', '3')) == '3' ? 'selected' : '' }}>3 Days</option>
                                        <option value="7" {{ old('lead_aging_alert', \App\Models\Setting::get('general.lead_aging_alert', '3')) == '7' ? 'selected' : '' }}>7 Days</option>
                                        <option value="14" {{ old('lead_aging_alert', \App\Models\Setting::get('general.lead_aging_alert', '3')) == '14' ? 'selected' : '' }}>14 Days</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="default_campaign_status" class="form-input">
                                        <option value="draft" {{ old('default_campaign_status', \App\Models\Setting::get('general.default_campaign_status', 'active')) == 'draft' ? 'selected' : '' }}>Draft - Manual Activation</option>
                                        <option value="active" {{ old('default_campaign_status', \App\Models\Setting::get('general.default_campaign_status', 'active')) == 'active' ? 'selected' : '' }}>Active - Ready for Leads</option>
                                        <option value="paused" {{ old('default_campaign_status', \App\Models\Setting::get('general.default_campaign_status', 'active')) == 'paused' ? 'selected' : '' }}>Paused - Review Required</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="daily_call_target" min="0" max="500" class="form-input" 
                                           value="{{ old('daily_call_target', \App\Models\Setting::get('general.daily_call_target', 100)) }}" 
                                           placeholder="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="min_call_duration" min="0" max="3600" class="form-input" 
                                           value="{{ old('min_call_duration', \App\Models\Setting::get('general.min_call_duration', 30)) }}" 
                                           placeholder="30">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="quality_threshold" class="form-input">
                                        <option value="6" {{ old('quality_threshold', \App\Models\Setting::get('general.quality_threshold', '7')) == '6' ? 'selected' : '' }}>6.0 - Basic Quality</option>
                                        <option value="7" {{ old('quality_threshold', \App\Models\Setting::get('general.quality_threshold', '7')) == '7' ? 'selected' : '' }}>7.0 - Good Quality</option>
                                        <option value="8" {{ old('quality_threshold', \App\Models\Setting::get('general.quality_threshold', '7')) == '8' ? 'selected' : '' }}>8.0 - High Quality</option>
                                        <option value="9" {{ old('quality_threshold', \App\Models\Setting::get('general.quality_threshold', '7')) == '9' ? 'selected' : '' }}>9.0 - Excellent Quality</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="auto_approval_rate" min="0" max="100" step="0.1" class="form-input" 
                                           value="{{ old('auto_approval_rate', \App\Models\Setting::get('general.auto_approval_rate', '5.0')) }}" 
                                           placeholder="5.0">
            ...
            <div id="attendance" class="settings-section">
                <div class="card">
                    ...
                    <form action="{{ route('admin.settings.attendance') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="24" name="work_hours" class="form-input" value="{{ old('work_hours', 8) }}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Attendance Reminder (minutes before shift)</label>
                                    <input type="number" min="0" max="120" name="attendance_reminder" class="form-input" value="{{ old('attendance_reminder', 15) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" max="10" name="max_breaks" class="form-input" value="{{ old('max_breaks', 3) }}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Min Break Duration (minutes)</label>
                                    <input type="number" min="1" max="120" name="min_break_duration" class="form-input" value="{{ old('min_break_duration', 10) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            ...
                            <div class="space-y-3">
                                @foreach(\App\Models\AllowedLocation::orderBy('created_at', 'desc')->get() as $location)
                                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">{{ $location->name }}</div>
                                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                                {{ ucfirst($location->location_type) }}: {{ $location->address }}
                                            </div>
                                        </div>
                                        <form action="{{ route('admin.settings.delete_location', $location->id) }}" method="POST" onsubmit="return confirm('Delete this location?')" class="inline">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    @endforeach
                                    @if(\App\Models\AllowedLocation::count() === 0)
                ...
                <div id="campaigns" class="settings-section">
                    <div class="card">
                        ...
                        <form action="{{ route('admin.settings.campaign') }}" method="POST" class="space-y-6">
                            @csrf
    ...
    <div id="location-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-6 m-4">
            ...
            <form action="{{ route('admin.settings.add_location') }}" method="POST" class="space-y-4">
                @csrf
                <div class="form-group">
...
function loadTabData(tabName) {
    ...
    switch(tabName) {
        case 'attendance':
            url = '{{ route("admin.settings.partial.attendance") }}';
            break;
        case 'campaigns':
            url = '{{ route("admin.settings.partial.campaign") }}';
            break;
        case 'users':
            url = '{{ route("admin.settings.partial.user") }}';
            break;
        default:
