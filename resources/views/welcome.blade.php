...
<head>
    ...
    <link rel="icon" type="image/png" href="/favicon.ico">    <link rel="canonical" href="{{ url('/') }}">
            ...
            <div class="flex justify-between items-center h-16 md:h-18 lg:h-20">
                ...
                <div class="flex items-center space-x-2 sm:space-x-3">
                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl gradient-primary flex items-center justify-center shadow-lg">
                        <img src="{{ asset('logo.png') }}" alt="Acraltech Solutions" class="w-6 h-6 sm:w-8 sm:h-8 rounded-lg" />
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    @auth
                        ...
                        @endphp
                        <a href="{{ $dashboardRoute }}" class="px-4 sm:px-6 py-2 sm:py-3 rounded-xl btn-secondary text-white font-semibold text-sm sm:text-base">Dashboard</a>
            ...
            <div class="px-4 sm:px-6 py-4 sm:py-6 space-y-3 sm:space-y-4 mobile-padding">
                ...
                @auth
                    <div class="pt-4 border-t border-slate-200 space-y-3" :class="{ 'border-white/15': isScrolled }">
                        <a href="{{ $dashboardRoute }}" class="block w-full px-4 py-3 rounded-xl btn-secondary text-white font-semibold text-center">Dashboard</a>
...
@include('components.floating-chat-guest')
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-12 h-12 rounded-xl gradient-primary flex items-center justify-center shadow-lg">
                        <img src="{{ asset('logo.png') }}" alt="Acraltech Solutions" class="w-8 h-8 rounded-lg" />
                    </div>
        ...
        <div class="border-t border-white/10 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="text-gray-400 text-sm">
                    &copy; {{ date('Y') }} Acraltech Solutions. All rights reserved.
                </div>
