...
<head>
    ...
    <title>@yield('title', 'Pay Per Call Dashboard') - {{ config('app.name', 'CRM System') }}</title>
    ...
    <div class="fixed inset-y-0 left-0 z-50 bg-white dark:bg-gray-800 shadow-xl transform transition-all duration-300 lg:translate-x-0"
        ...
        <div class="flex items-center justify-between h-16 px-6 sidebar-gradient">
            <div class="flex items-center gap-2 w-full">
                ...
                <h1 class="text-xl font-bold text-white whitespace-nowrap ml-2" x-show="!sidebarCollapsed" style="transition:all .2s">Pay Per Call</h1>
        ...
        <!-- Back to Main Admin -->
        <div class="px-3 pt-4" x-show="!sidebarCollapsed">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center py-2 px-3 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
        ...
        <nav class="mt-6 scrollbar-thin overflow-y-auto h-full pb-20 transition-all duration-200"
            ...
            <div class="space-y-2">
                ...
                <a href="{{ route('admin.pay-per-call.dashboard') }}" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.pay-per-call.dashboard') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                ...
                <!-- DID Management -->
                <div x-data="{ open: {{ request()->routeIs('admin.dids.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            ...
                            :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                        <i class="fas fa-phone-alt text-lg" :class="sidebarCollapsed ? '' : 'mr-3'"></i>
                        <span x-show="!sidebarCollapsed" class="transition-all duration-200">DID Management</span>
                    ...
                    <div x-show="open && !sidebarCollapsed" x-transition class="mt-2 space-y-1 ml-6">
                        <a href="{{ route('admin.dids.index') }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-list mr-2"></i>All DIDs
                        </a>
                        <a href="{{ route('admin.dids.create') }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-plus mr-2"></i>Add New DID
                        </a>
                        <a href="{{ route('admin.dids.analytics') }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-chart-line mr-2"></i>DID Analytics
                        </a>
                    </div>
                </div>
                
                <!-- Call Analytics -->
                <div x-data="{ open: {{ request()->routeIs('admin.call-analytics.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="w-full flex items-center py-3 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                            :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                        <i class="fas fa-chart-bar text-lg" :class="sidebarCollapsed ? '' : 'mr-3'"></i>
                        <span x-show="!sidebarCollapsed" class="transition-all duration-200">Call Analytics</span>
                        <i class="fas fa-chevron-down ml-auto transition-transform duration-200" :class="{ 'rotate-180': open, 'hidden': sidebarCollapsed }"></i>
                    </button>
                    <div x-show="open && !sidebarCollapsed" x-transition class="mt-2 space-y-1 ml-6">
                        <a href="{{ route('admin.call-analytics.index') }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-phone mr-2"></i>Call Logs
                        </a>
                        <a href="{{ route('admin.call-analytics.export') }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <!-- Call Routing -->
                <a href="{{ route('admin.pay-per-call.routing') }}" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.pay-per-call.routing') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                   :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                    <i class="fas fa-route text-lg" :class="sidebarCollapsed ? '' : 'mr-3'"></i>
                    <span x-show="!sidebarCollapsed">Call Routing</span>
                </a>
                
                <!-- Settings -->
                <a href="{{ route('admin.pay-per-call.index') }}" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.pay-per-call.index') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                   :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.publishers.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="w-full flex items-center py-3 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                            :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                        <i class="fas fa-users text-lg" :class="sidebarCollapsed ? '' : 'mr-3'"></i>
                        <span x-show="!sidebarCollapsed" class="transition-all duration-200">Publisher Management</span>
                        <i class="fas fa-chevron-down ml-auto transition-transform duration-200" :class="{ 'rotate-180': open, 'hidden': sidebarCollapsed }"></i>
                    </button>
                    <div x-show="open && !sidebarCollapsed" x-transition class="mt-2 space-y-1 ml-6">
                        <a href="{{ route('admin.publishers.index') }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-list mr-2"></i>All Publishers
                        </a>
                        <a href="{{ route('admin.publishers.create') }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-plus mr-2"></i>Add Publisher
                        </a>
                        <a href="#" onclick="alert('Bulk assign DIDs functionality')" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-phone-volume mr-2"></i>Bulk Assign DIDs
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="sticky top-0 z-40 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between px-6 h-16">
                ...
                <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <span>/</span>
                    <span class="text-gray-900 dark:text-white font-medium">@yield('title', 'Pay Per Call Dashboard')</span>
                </div>
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
                    <div class="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                        <span>&copy; {{ date('Y') }} CRM Pro - Pay Per Call. All rights reserved.</span>
