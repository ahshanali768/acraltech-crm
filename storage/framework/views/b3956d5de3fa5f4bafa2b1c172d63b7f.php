...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <form action="<?php echo e(route('admin.settings.attendance')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="time" 
                           id="login_time" 
                           name="login_time" 
                           value="<?php echo e($attendanceSettings['login_time']); ?>"
                ...
                <div>
                    ...
                    <input type="time" 
                           id="logout_time" 
                           name="logout_time" 
                           value="<?php echo e($attendanceSettings['logout_time']); ?>"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                           required>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               <?php echo e($attendanceSettings['email_notifications'] ? 'checked' : ''); ?>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               <?php echo e($attendanceSettings['bell_notifications'] ? 'checked' : ''); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="number" 
                           id="grace_period" 
                           name="grace_period" 
                           value="<?php echo e($attendanceSettings['grace_period']); ?>"
                           min="0" max="60"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="<?php echo e($attendanceSettings['late_fee_amount']); ?>"
                           min="0" step="0.01"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="<?php echo e($attendanceSettings['auto_absent_threshold']); ?>"
                           min="1" max="24"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                           required>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="<?php echo e($attendanceSettings['half_day_threshold']); ?>"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="<?php echo e($attendanceSettings['half_day_deduction']); ?>"
                           min="0" step="0.01"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="<?php echo e($attendanceSettings['monthly_absence_limit']); ?>"
                           min="0" max="31"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                           required>
                </div>
            ...
            <div>
                ...
                <input type="number" 
                       ...
                       value="<?php echo e($attendanceSettings['absence_penalty']); ?>"
                       min="0" step="0.01"
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                       required>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            ...
            <form id="addLocationForm" action="<?php echo e(route('admin.settings.add_location')); ?>" method="POST" class="mb-6">
                <?php echo csrf_field(); ?>
            ...
            <div class="space-y-3">
                <?php if($allowedLocations->count() > 0): ?>
                    <?php $__currentLoopData = $allowedLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div class="flex-1">
                                <div class="flex items-center space-x-2">
                                    <h4 class="font-medium text-gray-900 dark:text-white"><?php echo e($location->name); ?></h4>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($location->is_active ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200'); ?>">
                                        <?php echo e($location->is_active ? 'Active' : 'Inactive'); ?>

                                    </span>
                                </div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e($location->address ?? 'No address available'); ?></p>
                                <div class="flex items-center space-x-4 mt-2 text-xs text-gray-500 dark:text-gray-500">
                                    ...
                                    <?php if($location->radius_meters): ?>
                                        <span class="flex items-center">
                                            ...
                                            <?php echo e($location->radius_meters); ?>m radius
                                        </span>
                                    <?php endif; ?>
                                    <span>Added: <?php echo e($location->created_at ? $location->created_at->format('M j, Y') : 'Unknown'); ?></span>
                                </div>
                            </div>
                            <div class="flex items-center space-x-2">
                                <!-- Toggle Active Status -->
                                <form action="<?php echo e(route('admin.settings.toggle_location', $location->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                                            title="<?php echo e($location->is_active ? 'Deactivate' : 'Activate'); ?> location"
                                            class="inline-flex items-center px-2 py-1 rounded text-xs font-medium transition-colors <?php echo e($location->is_active ? 'bg-yellow-100 text-yellow-800 hover:bg-yellow-200 dark:bg-yellow-900 dark:text-yellow-200' : 'bg-green-100 text-green-800 hover:bg-green-200 dark:bg-green-900 dark:text-green-200'); ?>">
                                ...
                                <!-- Delete Location -->
                                <form action="<?php echo e(route('admin.settings.delete_location', $location->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
...
<!-- GPS Location functionality is now handled by the main settings page via AJAX --><?php /**PATH /home/ahshanali768/project-export/resources/views/admin/partials/attendance-management.blade.php ENDPATH**/ ?>