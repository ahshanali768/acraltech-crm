    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0 flex items-center space-x-4">
            ...
            <div class="flex items-center bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg px-3 py-2">
                ...
                <code class="text-sm font-bold text-yellow-900 dark:text-yellow-100 bg-yellow-100 dark:bg-yellow-800 px-2 py-1 rounded"><?php echo e($currentDidPassword ?? 'N/A'); ?></code>
            </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $campaigns ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 text-center">
                                <?php if($campaign->vertical): ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200">
                                        <?php switch($campaign->vertical):
                                            case ('ACA Health'): ?>
                                                🏥 <?php echo e($campaign->vertical); ?>

                                                <?php break; ?>
                                            <?php case ('Final Expense'): ?>
                                                ⚱️ <?php echo e($campaign->vertical); ?>

                                                <?php break; ?>
                                            <?php case ('Pest Control'): ?>
                                                🐛 <?php echo e($campaign->vertical); ?>

                                                <?php break; ?>
                                            <?php case ('Auto Insurance'): ?>
                                                🚗 <?php echo e($campaign->vertical); ?>
                                            ...
                                            <?php case ('SSDI'): ?>
                                                ...
                                                <?php break; ?>
                                            <?php case ('Debt Relief'): ?>
                                                💳 <?php echo e($campaign->vertical); ?>

                                                <?php break; ?>
                                            <?php case ('Tax Debt Relief'): ?>
                                                📊 <?php echo e($campaign->vertical); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 text-center font-mono">
                                <?php echo e($campaign->did ?? 'N/A'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 text-center">
                                ₹<?php echo e(number_format($campaign->commission_inr ?? 0, 2)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 text-center">
                                $<?php echo e(number_format($campaign->payout_usd ?? 0, 2)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <?php switch($campaign->status ?? 'draft'):
                                    case ('active'): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    <button onclick="editCampaign(<?php echo e($campaign->id); ?>)" 
                                        class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium">
                                        Edit
                                    </button>
                                    <button onclick="deleteCampaign(<?php echo e($campaign->id); ?>)" 
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.openAddCampaignModal = function() {
        ...
        campaignForm.action = '<?php echo e(route("admin.manage_campaigns.store")); ?>';
...
<!-- Campaign JavaScript functionality is now handled by the main settings page --><?php /**PATH /home/ahshanali768/project-export/resources/views/admin/partials/campaign-management.blade.php ENDPATH**/ ?>