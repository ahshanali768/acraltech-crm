...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - <?php echo e(config('app.name', 'CRM System')); ?></title>
        ...
        <nav class="mt-6 scrollbar-thin overflow-y-auto h-full pb-20 transition-all duration-200"
            ...
            <div class="space-y-2">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
                ...
                <!-- Leads Management -->
                <div x-data="{ open: <?php echo e(request()->routeIs('admin.view_leads', 'admin.import.*', 'admin.leads.*') ? 'true' : 'false'); ?> }">
                    ...
                    <div x-show="open && !sidebarCollapsed" x-transition class="mt-2 space-y-1 ml-6">
                        <a href="<?php echo e(route('admin.view_leads')); ?>" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-eye mr-2"></i>View All Leads
                        </a>
                        <a href="<?php echo e(route('admin.leads.import')); ?>" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                            <i class="fas fa-upload mr-2"></i>Import Leads
                        </a>
                        <a href="<?php echo e(route('admin.leads.export')); ?>" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <a href="<?php echo e(route('admin.payment')); ?>" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.payment') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
                   :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                    <i class="fas fa-credit-card text-lg" :class="sidebarCollapsed ? '' : 'mr-3'"></i>
                    <span x-show="!sidebarCollapsed">Payments</span>
                </a>
                <!-- Pay Per Call -->
                <a href="<?php echo e(route('admin.pay-per-call.dashboard')); ?>" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.pay-per-call.*', 'admin.dids.*', 'admin.call-analytics.*') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
                   :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                ...
                <a href="<?php echo e(route('admin.attendance.index')); ?>" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.attendance.*') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
                   :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                ...
                <a href="<?php echo e(route('admin.settings')); ?>" 
                   class="flex items-center py-3 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.settings') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
                   :class="sidebarCollapsed ? 'justify-center' : 'px-3'">
                        ...
                        <div class="flex-shrink-0">
                            <img class="w-8 h-8 rounded-full" src="
                                <?php if(auth()->user()->profile_picture): ?>
                                    <?php echo e(asset('storage/' . auth()->user()->profile_picture) . '?v=' . time()); ?>

                                <?php elseif(auth()->user()->avatar_style === 'multiavatar' && auth()->user()->avatar_seed): ?>
                                    <?php echo e(url('/multiavatar/' . auth()->user()->avatar_seed . '.svg') . '?v=' . time()); ?>

                                <?php elseif(auth()->user()->avatar_style && auth()->user()->avatar_seed): ?>
                                    https://api.dicebear.com/7.x/<?php echo e(auth()->user()->avatar_style); ?>/svg?seed=<?php echo e(auth()->user()->avatar_seed); ?>&r=<?php echo e(uniqid()); ?>

                                <?php else: ?>
                                    https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&background=3b82f6&color=fff
                                <?php endif; ?>
        ...
        <div class="sticky top-0 z-40 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between px-6 h-16">
                ...
                <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <span>/</span>
                    <span class="text-gray-900 dark:text-white font-medium"><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?></span>
                </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" 
                            ...
                            <img class="w-8 h-8 rounded-full" src="
                                ...
                                <?php endif; ?>
                            " alt="<?php echo e(auth()->user()->name); ?>">
                            <span class="hidden md:block text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e(auth()->user()->name); ?></span>
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
                    <div class="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                        <span>&copy; <?php echo e(date('Y')); ?> CRM Pro. All rights reserved.</span>
...
<?php /**PATH /home/ahshanali768/project-export/resources/views/layouts/admin.blade.php ENDPATH**/ ?>